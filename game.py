...
class GameUI:
    ...
    def draw_board(self, player=None, row=-1, column=-1, q=False):
        if player is not None:
            ...
            if q:
                ...
                text_rect = q_text.get_rect(center=(self.OFFSET + self.CHIP_RADIUS + self.CHIP_OFFSET * column + self.CHIP_SIZE * column,
